...
export default function Edit({ auth, major }: PageProps<{ major: Major }>) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('majors.update', major.id));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Jurusan</h2>}
        >
