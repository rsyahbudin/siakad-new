        ...
        <aside class="w-64 bg-gradient-to-b from-blue-800 via-blue-700 to-indigo-800 text-white flex flex-col relative overflow-hidden shadow-2xl">
            ...
            <nav class="flex-1 px-4 pb-4 custom-scrollbar overflow-y-auto relative z-10">
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.kepsek.index') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('admin.kepsek.*') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            <span class="font-medium text-sm">Akun Kepala Sekolah</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('admin.exam-schedules.index') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('admin.exam-schedules.*') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('guru.exam-schedule') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('guru.exam-schedule') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('siswa.exam-schedule') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('siswa.exam-schedule') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                            </svg>
                            <span class="font-medium">Jadwal Ujian</span>
                    ...
                    <li class="pt-4">
                        <div class="px-4 py-2">
                            <p class="text-xs font-semibold text-blue-300 uppercase tracking-wider">Laporan</p>
                        </div>
                    </li>
                    ...
                    <li class="pt-4">
                        <div class="px-4 py-2">
                            <p class="text-xs font-semibold text-blue-300 uppercase tracking-wider">Manajemen Akademik</p>
                        </div>
                    </li>

                    <li>
                        <a href="{{ route('kepala.kenaikan-kelas') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('kepala.kenaikan-kelas*') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                            </svg>
                    ...
                    <li class="pt-4">
                        <div class="px-4 py-2">
                            <p class="text-xs font-semibold text-blue-300 uppercase tracking-wider">Monitoring</p>
                        </div>
                    </li>

                    <li>
                        <a href="{{ route('kepala.monitoring.ppdb') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('kepala.monitoring.ppdb') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            </svg>
                            <span class="font-medium">Monitoring PPDB</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('kepala.monitoring.siswa-pindahan') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('kepala.monitoring.siswa-pindahan') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                            </svg>
                            <span class="font-medium">Siswa Pindahan</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('kepala.monitoring.jadwal-ujian') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('kepala.monitoring.jadwal-ujian') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                            </svg>
                            <span class="font-medium">Jadwal Ujian</span>
                    ...
                    <li>
                        <a href="{{ route('kepala.monitoring.guru') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('kepala.monitoring.guru') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                            </svg>
                            <span class="font-medium">Monitoring Guru</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('kepala.monitoring.kelas') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('kepala.monitoring.kelas') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                            <span class="font-medium">Monitoring Kelas</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('kepala.monitoring.nilai') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('kepala.monitoring.nilai') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                            </svg>
                            <span class="font-medium">Monitoring Nilai</span>
                        </a>
                    </li>
                    ...
                    <li class="pt-4">
                        <div class="px-4 py-2">
                            <p class="text-xs font-semibold text-blue-300 uppercase tracking-wider">Pengaturan</p>
                        </div>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('kepala.pengaturan.akun') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('kepala.pengaturan.akun') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('wali.exam-schedule') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/10 {{ request()->routeIs('wali.exam-schedule') ? 'bg-white/20 shadow-lg' : '' }} group">
                            <svg class="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                            </svg>
                            <span class="font-medium">Jadwal Ujian Anak</span>
                        </a>
                    </li>
                    @endif
                </ul>
