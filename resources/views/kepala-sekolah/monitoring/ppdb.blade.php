...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Monitoring PPDB</h1>
                <p class="text-gray-600 mt-1">Pantau dan kelola data pendaftaran siswa baru</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-lg font-semibold text-gray-900">Data Pendaftaran PPDB</h2>
            </div>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nilai Test</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ $application->test_score }}</span>
                            @else
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <div class="flex items-start gap-3">
            ...
            <div>
                <h3 class="text-lg font-semibold text-blue-900 mb-2">Informasi Monitoring PPDB</h3>
                <div class="text-sm text-blue-800 space-y-2">
                    <p>Halaman ini menampilkan data pendaftaran siswa baru melalui sistem PPDB online.</p>
                    <p>Fitur monitoring ini memungkinkan kepala sekolah untuk:</p>
                    <ul class="list-disc list-inside space-y-1 ml-4">
                        <li>Memantau jumlah pendaftar secara real-time</li>
                        <li>Melihat status pendaftaran (Menunggu/Diterima/Ditolak)</li>
                        <li>Memantau nilai test calon siswa</li>
                        <li>Mengawasi proses seleksi siswa baru</li>
                    </ul>
                </div>
            </div>
        </div>
