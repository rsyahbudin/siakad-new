...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Monitoring Kelas</h1>
                <p class="text-gray-600 mt-1">Pantau dan kelola data kelas sekolah</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $statistics['homeroom_teachers'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Rata-rata Siswa</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $statistics['avg_students'] }}</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-sm text-gray-500">Angkatan {{ $classroom->grade }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($classroom->major)
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="text-sm font-medium text-gray-900">{{ $classroom->students_count }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="text-sm text-gray-900">{{ $classroom->capacity ?? 40 }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            @php
                            $capacity = $classroom->capacity ?? 40;
                            $percentage = ($classroom->students_count / $capacity) * 100;
                            @endphp
                            ...
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                ...
                                Penuh ({{ number_format($percentage, 1) }}%)
                            </span>
                            ...
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                ...
                                Hampir Penuh ({{ number_format($percentage, 1) }}%)
                            </span>
                            @else
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                Tersedia ({{ number_format($percentage, 1) }}%)
                            </span>
                            @endif
                        </td>
                    </tr>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <div class="flex items-start gap-3">
            ...
            <div>
                <h3 class="text-lg font-semibold text-blue-900 mb-2">Informasi Monitoring Kelas</h3>
                <div class="text-sm text-blue-800 space-y-2">
                    <p>Halaman ini menampilkan data kelas dan distribusi siswa di sekolah.</p>
                    <p>Fitur monitoring ini memungkinkan kepala sekolah untuk:</p>
                    <ul class="list-disc list-inside space-y-1 ml-4">
                        <li>Memantau jumlah kelas dan kapasitas masing-masing</li>
                        <li>Melihat distribusi siswa per kelas</li>
                        <li>Memantau penugasan wali kelas</li>
                        <li>Mengawasi tingkat kepadatan kelas</li>
                    </ul>
                </div>
            </div>
        </div>
