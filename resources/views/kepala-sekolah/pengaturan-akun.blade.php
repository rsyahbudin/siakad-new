...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form method="POST" action="{{ route('kepala.pengaturan.akun.update') }}" class="p-6 space-y-8">
            @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email', $user->email) }}"
                                ...
                                placeholder="Contoh: kepala@sekolah.com">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="full_name" value="{{ old('full_name', $profile->full_name ?? '') }}"
                                ...
                                placeholder="Contoh: Dr. Ahmad Supriadi, M.Pd.">
                        </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="address" rows="3"
                            ...
                            placeholder="Contoh: Jl. Pendidikan No. 123, Jakarta">{{ old('address', $profile->address ?? '') }}</textarea>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="last_education" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('last_education') border-red-500 @enderror">
                                ...
                                <option value="S1" {{ old('last_education', $profile->last_education ?? '') == 'S1' ? 'selected' : '' }}>S1 (Sarjana)</option>
                                <option value="S2" {{ old('last_education', $profile->last_education ?? '') == 'S2' ? 'selected' : '' }}>S2 (Magister)</option>
                                <option value="S3" {{ old('last_education', $profile->last_education ?? '') == 'S3' ? 'selected' : '' }}>S3 (Doktor)</option>
                                <option value="D3" {{ old('last_education', $profile->last_education ?? '') == 'D3' ? 'selected' : '' }}>D3 (Diploma)</option>
                                <option value="D4" {{ old('last_education', $profile->last_education ?? '') == 'D4' ? 'selected' : '' }}>D4 (Diploma)</option>
                                <option value="SMA/SMK" {{ old('last_education', $profile->last_education ?? '') == 'SMA/SMK' ? 'selected' : '' }}>SMA/SMK</option>
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="graduation_year" value="{{ old('graduation_year', $profile->graduation_year ?? '') }}"
            ...
            <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                <a href="{{ route('kepala.dashboard') }}" class="inline-flex items-center gap-2 px-6 py-3 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="p-6 space-y-6">
            ...
            <form method="POST" action="{{ route('kepala.pengaturan.akun.password') }}" class="space-y-6">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="current_password"
                                class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('current_password') border-red-500 @enderror"
                ...
                <div class="flex justify-end pt-6 border-t border-gray-200">
                    <button type="submit" class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg font-medium transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        Update Password
