...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <form action="{{ route('kepala.change-password') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-end space-x-4 pt-4">
                <a href="{{ route('kepala.dashboard') }}" class="px-6 py-3 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors font-medium">
                    Batal
                </a>
