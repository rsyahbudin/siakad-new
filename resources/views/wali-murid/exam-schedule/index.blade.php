...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>{{ $examSchedules->total() }} Jadwal Ujian</span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-lg font-semibold text-gray-900">Jadwal Ujian Anak</h2>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
        <div class="flex flex-col items-center">
            ...
            <p class="text-gray-500">Jadwal ujian anak akan ditampilkan di sini ketika tersedia untuk semester aktif.</p>
        </div>
    </div>
    @endif
</div>
