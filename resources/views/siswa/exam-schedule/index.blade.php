...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Jadwal Ujian Saya</h1>
                <p class="text-gray-600 mt-1">Lihat jadwal ujian UTS dan UAS Anda</p>
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
        <div class="flex items-start gap-3">
            ...
            <div>
                <h3 class="text-lg font-semibold text-yellow-900 mb-2">Panduan Penting</h3>
                <ul class="text-yellow-800 space-y-1 text-sm">
                    <li>• Datang 30 menit sebelum ujian dimulai</li>
                    <li>• Bawa alat tulis yang diperlukan</li>
                    <li>• Jangan membawa HP atau alat elektronik</li>
                    <li>• Ikuti instruksi pengawas dengan baik</li>
                    <li>• Jaga ketenangan selama ujian berlangsung</li>
                    <li>• Serahkan lembar jawaban tepat waktu</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-lg font-semibold text-gray-900">Jadwal Ujian</h2>
            </div>
        </div>
