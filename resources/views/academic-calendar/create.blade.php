    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Event Kalender Akademik</h1>
            ...
            <div class="p-6">
                <form action="{{ route('academic-calendar.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Start Time -->
                        <div id="start_time_group" class="{{ old('is_all_day', true) ? 'hidden' : '' }}">
                        ...
                        <!-- End Time -->
                        <div id="end_time_group" class="{{ old('is_all_day', true) ? 'hidden' : '' }}">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="meeting" {{ old('type') == 'meeting' ? 'selected' : '' }}>Rapat</option>
