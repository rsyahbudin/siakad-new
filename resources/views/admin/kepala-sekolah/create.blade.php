...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Kepala Sekolah</h1>
                <p class="text-gray-600">Tambahkan kepala sekolah baru ke sistem</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form method="POST" action="{{ route('admin.kepsek.store') }}" class="p-6 space-y-8">
            @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="address" rows="3"
                            ...
                            placeholder="Contoh: Jl. Pendidikan No. 123, Jakarta"></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="last_education" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('last_education') border-red-500 @enderror">
                                ...
                                <option value="D4">D4 (Diploma)</option>
