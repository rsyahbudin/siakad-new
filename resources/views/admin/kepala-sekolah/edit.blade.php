...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Kepala Sekolah</h1>
                <p class="text-gray-600">Perbarui informasi kepala sekolah</p>
            </div>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('admin.kepsek.update', $kepala->id) }}" class="p-6 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nip" value="{{ old('nip', $kepala->kepalaSekolah->nip ?? '') }}"
                                ...
                                placeholder="Contoh: 198765432109876543" maxlength="18" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="full_name" value="{{ old('full_name', $kepala->kepalaSekolah->full_name ?? '') }}"
                                ...
                                placeholder="Contoh: Dr. Ahmad Supriadi, M.Pd." required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="phone_number" value="{{ old('phone_number', $kepala->kepalaSekolah->phone_number ?? '') }}"
                                class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('phone_number') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="address" rows="3"
                            ...
                            placeholder="Contoh: Jl. Pendidikan No. 123, Jakarta">{{ old('address', $kepala->kepalaSekolah->address ?? '') }}</textarea>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="last_education" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('last_education') border-red-500 @enderror">
                                <option value="">- Pilih Pendidikan -</option>
                                <option value="S1" {{ old('last_education', $kepala->kepalaSekolah->last_education ?? '') == 'S1' ? 'selected' : '' }}>S1 (Sarjana)</option>
                                <option value="S2" {{ old('last_education', $kepala->kepalaSekolah->last_education ?? '') == 'S2' ? 'selected' : '' }}>S2 (Magister)</option>
                                <option value="S3" {{ old('last_education', $kepala->kepalaSekolah->last_education ?? '') == 'S3' ? 'selected' : '' }}>S3 (Doktor)</option>
                                <option value="D3" {{ old('last_education', $kepala->kepalaSekolah->last_education ?? '') == 'D3' ? 'selected' : '' }}>D3 (Diploma)</option>
                                <option value="D4" {{ old('last_education', $kepala->kepalaSekolah->last_education ?? '') == 'D4' ? 'selected' : '' }}>D4 (Diploma)</option>
                                <option value="SMA/SMK" {{ old('last_education', $kepala->kepalaSekolah->last_education ?? '') == 'SMA/SMK' ? 'selected' : '' }}>SMA/SMK</option>
                            </select>
                        </div>
                        @error('last_education')<div class="text-red-500 text-sm mt-1">{{ $message }}</div>@enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="degree" value="{{ old('degree', $kepala->kepalaSekolah->degree ?? '') }}"
                                class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('degree') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="major" value="{{ old('major', $kepala->kepalaSekolah->major ?? '') }}"
                                ...
                                placeholder="Contoh: Pendidikan Administrasi Pendidikan">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="university" value="{{ old('university', $kepala->kepalaSekolah->university ?? '') }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="graduation_year" value="{{ old('graduation_year', $kepala->kepalaSekolah->graduation_year ?? '') }}"
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-3 pb-2 border-b border-gray-200">
                    ...
                    <h2 class="text-lg font-semibold text-gray-900">Informasi TTL</h2>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="birth_place" value="{{ old('birth_place', $kepala->kepalaSekolah->birth_place ?? '') }}"
                                class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('birth_place') border-red-500 @enderror"
            ...
            <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                <a href="{{ route('admin.kepsek.index') }}" class="inline-flex items-center gap-2 px-6 py-3 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors">
